...
USER root
RUN dnf install -y grub2-tools-minimal openssl gcc python3.11 python3.11-pip python3.11-devel openldap-devel butane
...
RUN pip3.11 install pynetbox netaddr pexpect py-pure-client purestorage dnspython python-ldap passlib
